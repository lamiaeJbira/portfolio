...
export const iconPaths = {
    ...
    <!-- méridien principal -->
    <path d="M128 32c32 0 64 48 64 96s-32 96-64 96-64-48-64-96 32-96 64-96Z"
          fill="none"
          stroke="currentColor"
          stroke-linecap="round"
          stroke-linejoin="round"
  ...
  `,
	'server': `
    <!-- racks -->
    <rect x="32" y="48"  width="192" height="64" rx="8"
          fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    <rect x="32" y="144" width="192" height="64" rx="8"
          fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    <!-- séparation -->
    <line x1="32" y1="112" x2="224" y2="112"
          fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    <!-- indicateurs -->
    <circle cx="80" cy="80"  r="12" fill="currentColor" stroke="none"/>
    <circle cx="80" cy="176" r="12" fill="currentColor" stroke="none"/>
  `,

	/* Data-engineering / database */
	'database': `
    <!-- couvercle -->
    <ellipse cx="128" cy="48" rx="88" ry="32"
             fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    <!-- corps -->
    <path d="M40 48v160c0 17.6 39.4 32 88 32s88-14.4 88-32V48"
          fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    <!-- tranche intermédiaire -->
    <path d="M40 144c0 17.6 39.4 32 88 32s88-14.4 88-32"
          fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  `,
	'brain': '<path d="M226.45,124.78c0-39.43-31.45-71.32-70.43-72.28-1.16-.02-2.31-.08-3.46-.18-2.77-.25-4.56-2.55-4.6-5.33l0-.02-.01-.17v-7.13A39.42,39.42,0,0,0,132.95,4C93.44,4.29,64.39,35.92,64.14,75.3A72.1,72.1,0,0,0,54.12,76C15.15,76,0,111.35,0,141.43V184c0,30.08,15.15,65.43,54.12,65.43A72.36,72.36,0,0,0,64.38,236.7c.25,39.39,29.25,71.02,68.77,71.32A39.42,39.42,0,0,0,160.35,244V236.85l.01-.17-.02-.02c-.05-2.78,1.83-5.07,4.6-5.32,1.15-.11,2.3-.17,3.46-.19,39.09-.95,70.45-32.84,70.45-72.28v-.03h.6c.32-.05.6-.28.6-.6h0V128.64c0-.32-.28-.6-.6-.6Zm-66.34,65.2a6,6,0,0,1-6,6H94.89a6,6,0,0,1-6-6v-34.92h71.22Z"/>',
};
